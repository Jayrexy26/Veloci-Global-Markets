/* Veloci Global Markets — ISO 3166-1 alpha-2 country list.
   Shared by ops-new.html (blocking UI) and blocked-new.html (label lookup). */
(function () {
  const RAW =
    ...
    "BL:Saint Barthélemy|BM:Bermuda|BN:Brunei Darussalam|BO:Bolivia|BQ:Caribbean Netherlands|" +
    ...
    "CG:Congo (Republic)|CH:Switzerland|CI:Côte d'Ivoire|CK:Cook Islands|CL:Chile|CM:Cameroon|" +
    "CN:China|CO:Colombia|CR:Costa Rica|CU:Cuba|CV:Cabo Verde|CW:Curaçao|CX:Christmas Island|" +
    "CY:Cyprus|CZ:Czechia|DE:Germany|DJ:Djibouti|DK:Denmark|DM:Dominica|DO:Dominican Republic|" +
    ...
    "GR:Greece|GS:South Georgia and South Sandwich Islands|GT:Guatemala|GU:Guam|GW:Guinea-Bissau|" +
    ...
    "TZ:Tanzania|UA:Ukraine|UG:Uganda|UM:U.S. Minor Outlying Islands|US:United States|" +
  ...
  /* ISO code -> emoji flag, via regional indicator symbols */
  function flag(code) {
